 ...
 */
function useNavigationPreviewComplete(handler, componentIdOrOptions) {
    ...
    warnIfMissingComponentId_1.default('useNavigationPreviewComplete', componentId, global);
    react_1.useLayoutEffect(function () {
        var subscription = react_native_navigation_1.Navigation.events().registerPreviewCompletedListener(function (event) {
            return triggerIfComponentIdMatches_1.default(handler, event, componentId);
        });
        return function () { return subscription.remove(); };
    }, [handler, componentId]);
}
exports.default = useNavigationPreviewComplete;
//# sourceMappingURL=useNavigationPreviewComplete.js.map