...
export declare type TraceEventJSONObject = {
    /**
...
export declare type TraceEventJSONArray = Event[];
export declare type TraceEventJSON = TraceEventJSONArray | TraceEventJSONObject;
